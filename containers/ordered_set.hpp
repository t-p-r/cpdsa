 ...
 * have time complexity O(log(_RB - _LB)). Since @c _LB and @c _RB are
 * defaulted to around 1 billion, they should be changed to suit specific needs
 * (i.e. if @c _Tp is long long).
 */
template <typename _Tp, _Tp _LB = 1000000000, _Tp _RB = 1000000001>
class ordered_set {
   private:
    /**
